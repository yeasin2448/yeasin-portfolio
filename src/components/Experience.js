      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            ...
            company="Redlimesolutions"
            companyLink="https://www.redlimesolutions.com/"
            time="2023-Present"
            address="Dallas, TX"
            work="Worked on a team responsible for developing new features for RL Technology, 
            including improving the accuracy and relevance of search results and 
            developing new tools for data analysis and visualization."
          />
          <Details
            position="Frontend Developer"
            company="JRK International Ltd"
            companyLink="https://jrkint.com/"
            time="2022-2023"
            address="Manor Park, UK"
            work="Worked on a team responsible for developing new features for RL Technology, 
            including improving the accuracy and relevance of search results and 
            developing new tools for data analysis and visualization."
          />
          <Details
            position="Frontend Developer"
            company="Infoinlet"
            companyLink="https://infoinlet.com/"
            time="2020-2021"
            address="East Hazipara, BD"
            work="Worked on a team responsible for developing new features for RL Technology, 
            including improving the accuracy and relevance of search results and 
            developing new tools for data analysis and visualization."
          />
