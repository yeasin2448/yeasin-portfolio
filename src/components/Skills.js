  ...
  return (
    <>
      ...
      <div className="w-full h-[100vh] relative bg-circularLight dark:bg-circularDark  flex items-center justify-center  mb-64 md:mb-32 rounded-full lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd  sm:bg-circularLightSm sm:dark:bg-circularDarkSm lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]">
        ...
        <Skill name="CSS" x="30vw" y="7vw" />
        <Skill name="JavaScript" x="-24vw" y="-6vw" />
        <Skill name="ReactJS" x="0vw" y="-22vw" />
        <Skill name="Angular" x="-20vw" y="-15vw" />
        <Skill name="Bootstrap" x="15vw" y="-12vw" />
        <Skill name="Tailwindcss" x="30vw" y="-5vw" />
        <Skill name="Sass" x="20vw" y="-20vw" />
        <Skill name="jQuery" x="15vw" y="12vw" />
        <Skill name="AMP" x="0vw" y="18vw" />
        <Skill name="AdobeXD" x="-25vw" y="18vw" />
      </div>
    </>
  );
};
